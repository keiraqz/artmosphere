...
if __name__ == '__main__':
    ...
    df_RDD = df.map(lambda x: {"artwork_id": x.id,"title":x.title, "artist_link": x._links.artists.href, "collecting_institution":x.collecting_institution, "created_at":x.created_at, "gene_link":x._links.genes.href, "image_link":x._links.thumbnail.href,"sold":str(x.sold)})
    # print df_RDD.first()
